package io.github.zzhorizonzz.client.jwt_templates.item;
...
public class WithTemplatePatchRequestBody implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private WithTemplatePatchRequestBodyClaims claims;
    /**
    ...
    /**
     * Instantiates a new WithTemplatePatchRequestBody and sets the default values.
     */
    public WithTemplatePatchRequestBody() {
        this.setAdditionalData(new HashMap<>());
    }
    /**
     * Creates a new instance of the appropriate class based on discriminator value
     * @param parseNode The parse node to use to read the discriminator value and create the object
     * @return a WithTemplatePatchRequestBody
     */
    @jakarta.annotation.Nonnull
    public static WithTemplatePatchRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new WithTemplatePatchRequestBody();
    }
    /**
     ...
     * @return a WithTemplatePatchRequestBodyClaims
     */
    @jakarta.annotation.Nullable
    public WithTemplatePatchRequestBodyClaims getClaims() {
        return this.claims;
    }
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("claims", (n) -> { this.setClaims(n.getObjectValue(WithTemplatePatchRequestBodyClaims::createFromDiscriminatorValue)); });
     ...
     */
    public void setClaims(@jakarta.annotation.Nullable final WithTemplatePatchRequestBodyClaims value) {
        this.claims = value;
    }
    /**
