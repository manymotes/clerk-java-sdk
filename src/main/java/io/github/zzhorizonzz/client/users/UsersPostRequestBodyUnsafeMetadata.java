...
public class UsersPostRequestBodyUnsafeMetadata implements AdditionalDataHolder, Parsable {
    /**
     * Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
     */
    private Map<String, Object> additionalData;
    /**
     * Instantiates a new UsersPostRequestBodyUnsafeMetadata and sets the default values.
     */
    public UsersPostRequestBodyUnsafeMetadata() {
    ...
    public static UsersPostRequestBodyUnsafeMetadata createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
        Objects.requireNonNull(parseNode);
        return new UsersPostRequestBodyUnsafeMetadata();
    }
    /**
