...
import io.github.zzhorizonzz.client.organizations.item.memberships.item.WithUserItemRequestBuilder;
...
public class MembershipsRequestBuilder extends BaseRequestBuilder {
    /**
     * Gets an item from the io.github.zzhorizonzz.client.organizations.item.memberships.item collection
