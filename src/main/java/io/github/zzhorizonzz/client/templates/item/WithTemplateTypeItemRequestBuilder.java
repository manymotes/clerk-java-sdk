package io.github.zzhorizonzz.client.templates.item;
...
import io.github.zzhorizonzz.client.templates.item.item.WithSlugItemRequestBuilder;
...
public class WithTemplateTypeItemRequestBuilder extends BaseRequestBuilder {
    /**
     * Gets an item from the io.github.zzhorizonzz.client.templates.item.item collection
