...
public class OTP implements Parsable {
    /**
    ...
    public static OTP createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("status", (n) -> { this.setStatus(n.getEnumValue(OTPStatus::forValue)); });
        deserializerMap.put("strategy", (n) -> { this.setStrategy(n.getEnumValue(OTPStrategy::forValue)); });
     ...
     * @return a OTPStrategy
     */
    @jakarta.annotation.Nullable
    public OTPStrategy getStrategy() {
     ...
     */
    public void setStatus(@jakarta.annotation.Nullable final OTPStatus value) {
        this.status = value;
    }
    /**
     ...
     */
    public void setStrategy(@jakarta.annotation.Nullable final OTPStrategy value) {
        this.strategy = value;
    }
}
