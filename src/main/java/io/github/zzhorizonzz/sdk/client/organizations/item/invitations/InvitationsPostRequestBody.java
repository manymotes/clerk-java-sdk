package io.github.zzhorizonzz.sdk.client.organizations.item.invitations;
...
public class InvitationsPostRequestBody implements AdditionalDataHolder, Parsable {
    /**
     ...
     */
    private InvitationsPostRequestBodyPrivateMetadata privateMetadata;
    /**
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("private_metadata", (n) -> { this.setPrivateMetadata(n.getObjectValue(InvitationsPostRequestBodyPrivateMetadata::createFromDiscriminatorValue)); });
     ...
     * @return a InvitationsPostRequestBodyPrivateMetadata
     */
    @jakarta.annotation.Nullable
    public InvitationsPostRequestBodyPrivateMetadata getPrivateMetadata() {
     ...
     */
    public void setPrivateMetadata(@jakarta.annotation.Nullable final InvitationsPostRequestBodyPrivateMetadata value) {
