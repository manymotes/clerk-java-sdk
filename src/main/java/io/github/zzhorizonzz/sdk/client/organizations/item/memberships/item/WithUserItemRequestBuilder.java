package io.github.zzhorizonzz.sdk.client.organizations.item.memberships.item;
...
import io.github.zzhorizonzz.sdk.client.organizations.item.memberships.item.metadata.MetadataRequestBuilder;
...
public class WithUserItemRequestBuilder extends BaseRequestBuilder {
    ...
    public WithUserItemRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organizations/{organization_id}/memberships/{user_id}", pathParameters);
    }
    /**
     * Instantiates a new WithUser_ItemRequestBuilder and sets the default values.
    ...
    public WithUserItemRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/organizations/{organization_id}/memberships/{user_id}", rawUrl);
    }
    /**
    ...
    public OrganizationMembership delete() {
        return delete(null);
    }
    /**
     * Removes the given membership from the organization
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationMembership delete(@jakarta.annotation.Nullable final java.util.function.Consumer<DeleteRequestConfiguration> requestConfiguration) {
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationMembership patch(@jakarta.annotation.Nonnull final WithUserPatchRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public OrganizationMembership patch(@jakarta.annotation.Nonnull final WithUserPatchRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PatchRequestConfiguration> requestConfiguration) {
