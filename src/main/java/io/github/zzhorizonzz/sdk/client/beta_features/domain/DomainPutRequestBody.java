...
public class DomainPutRequestBody implements Parsable {
    /**
     ...
     * @return a DomainPutRequestBody
     */
    @jakarta.annotation.Nonnull
    public static DomainPutRequestBody createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
