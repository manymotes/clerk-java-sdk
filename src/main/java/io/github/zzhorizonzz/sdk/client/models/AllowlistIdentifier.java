...
public class AllowlistIdentifier implements Parsable {
    /**
     ...
     */
    private AllowlistIdentifierIdentifierType identifierType;
    /**
     * The instance_id property
     */
    private String instanceId;
    /**
     * The invitation_id property
     */
    private String invitationId;
    /**
     * String representing the object's type. Objects of the same type share the same value.
     */
    private AllowlistIdentifierObject object;
    /**
    ...
    public static AllowlistIdentifier createFromDiscriminatorValue(@jakarta.annotation.Nonnull final ParseNode parseNode) {
    ...
    public Map<String, java.util.function.Consumer<ParseNode>> getFieldDeserializers() {
        ...
        deserializerMap.put("identifier_type", (n) -> { this.setIdentifierType(n.getEnumValue(AllowlistIdentifierIdentifierType::forValue)); });
        deserializerMap.put("instance_id", (n) -> { this.setInstanceId(n.getStringValue()); });
        deserializerMap.put("invitation_id", (n) -> { this.setInvitationId(n.getStringValue()); });
        deserializerMap.put("object", (n) -> { this.setObject(n.getEnumValue(AllowlistIdentifierObject::forValue)); });
    ...
    /**
     * Gets the identifier property value. An email address or a phone number.
     * @return a String
     */
    @jakarta.annotation.Nullable
     ...
     * @return a AllowlistIdentifierIdentifierType
     */
    @jakarta.annotation.Nullable
    public AllowlistIdentifierIdentifierType getIdentifierType() {
    ...
    /**
     * Gets the invitation_id property value. The invitation_id property
     * @return a String
     */
    @jakarta.annotation.Nullable
     ...
     * @return a AllowlistIdentifierObject
     */
    @jakarta.annotation.Nullable
    public AllowlistIdentifierObject getObject() {
        return this.object;
    }
    /**
    ...
    public void serialize(@jakarta.annotation.Nonnull final SerializationWriter writer) {
        ...
        writer.writeStringValue("invitation_id", this.getInvitationId());
    ...
    /**
     * Sets the identifier property value. An email address or a phone number.
     ...
     */
    public void setIdentifierType(@jakarta.annotation.Nullable final AllowlistIdentifierIdentifierType value) {
    ...
    /**
     * Sets the invitation_id property value. The invitation_id property
     * @param value Value to set for the invitation_id property.
     */
    public void setInvitationId(@jakarta.annotation.Nullable final String value) {
     ...
     */
    public void setObject(@jakarta.annotation.Nullable final AllowlistIdentifierObject value) {
        this.object = value;
    }
    /**
