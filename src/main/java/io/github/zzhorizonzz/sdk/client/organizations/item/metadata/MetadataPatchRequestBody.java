package io.github.zzhorizonzz.sdk.client.organizations.item.metadata;
...
public class MetadataPatchRequestBody implements Parsable {
    ...
    /**
     * Gets the private_metadata property value. Metadata saved on the organization that is only visible to your backend.The new object will be merged with the existing value.
    ...
    /**
     * Gets the public_metadata property value. Metadata saved on the organization, that is visible to both your frontend and backend.The new object will be merged with the existing value.
    ...
    /**
     * Sets the private_metadata property value. Metadata saved on the organization that is only visible to your backend.The new object will be merged with the existing value.
    ...
    /**
     * Sets the public_metadata property value. Metadata saved on the organization, that is visible to both your frontend and backend.The new object will be merged with the existing value.
