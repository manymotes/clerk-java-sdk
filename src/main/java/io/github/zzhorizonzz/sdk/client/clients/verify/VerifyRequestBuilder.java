package io.github.zzhorizonzz.sdk.client.clients.verify;
...
public class VerifyRequestBuilder extends BaseRequestBuilder {
    ...
    public VerifyRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/clients/verify", pathParameters);
    }
    /**
     * Instantiates a new VerifyRequestBuilder and sets the default values.
    ...
    public VerifyRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
        super(requestAdapter, "{+baseurl}/clients/verify", rawUrl);
    }
    /**
    ...
    public Client post(@jakarta.annotation.Nonnull final VerifyPostRequestBody body) {
     ...
     */
    @jakarta.annotation.Nullable
    public Client post(@jakarta.annotation.Nonnull final VerifyPostRequestBody body, @jakarta.annotation.Nullable final java.util.function.Consumer<PostRequestConfiguration> requestConfiguration) {
