...
//import io.github.zzhorizonzz.sdk.client.users.models.DeletedObject;
...
import io.github.zzhorizonzz.sdk.client.models.TotalCount;
import io.github.zzhorizonzz.sdk.client.models.User;
import io.github.zzhorizonzz.sdk.client.users.item.mfa.MfaDeleteResponse;
import io.github.zzhorizonzz.sdk.client.users.item.oauth_access_tokens.item.WithProvider;
...
public class UserService extends BaseService {
    ...
    /**
     * @see io.github.zzhorizonzz.sdk.client.users.UsersRequestBuilder#post(io.github.zzhorizonzz.sdk.client.users.UsersPostRequestBody)
     */
    ...
    /**
     * @see io.github.zzhorizonzz.sdk.client.users.UsersRequestBuilder#get()
     */
    ...
    /**
     * @see io.github.zzhorizonzz.sdk.client.users.count.CountRequestBuilder#get()
     */
    ...
    /**
     * @see io.github.zzhorizonzz.sdk.client.users.item.WithUserItemRequestBuilder#get()
     */
    ...
    /**
     * @see io.github.zzhorizonzz.sdk.client.users.item.WithUserItemRequestBuilder#delete()
     */
    ...
    /**
     * @see io.github.zzhorizonzz.sdk.client.users.item.WithUserItemRequestBuilder#patch(io.github.zzhorizonzz.sdk.client.users.item.WithUserPatchRequestBody)
     */
    ...
    /**
     * @see io.github.zzhorizonzz.sdk.client.users.item.metadata.MetadataRequestBuilder#patch(io.github.zzhorizonzz.sdk.client.users.item.metadata.MetadataPatchRequestBody)
     */
    ...
    /**
     * @see io.github.zzhorizonzz.sdk.client.users.item.oauth_access_tokens.item.WithProviderItemRequestBuilder#get()
     */
    ...
    /**
     * @see io.github.zzhorizonzz.sdk.client.users.item.ban.BanRequestBuilder#post()
     */
    ...
    /**
     * @see io.github.zzhorizonzz.sdk.client.users.item.unban.UnbanRequestBuilder#post()
     */
    ...
    /**
     * @see io.github.zzhorizonzz.sdk.client.users.item.lock.LockRequestBuilder#post()
     */
    ...
    /**
     * @see io.github.zzhorizonzz.sdk.client.users.item.unlock.UnlockRequestBuilder#post()
     */
    ...
    /**
     * @see io.github.zzhorizonzz.sdk.client.users.item.organization_memberships.OrganizationMembershipsRequestBuilder#get(Consumer)
     */
